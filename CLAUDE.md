...
python facebook_script/pages.py --no-groups                       # pages seulement (défaut : pages.txt ET groups.txt)
python facebook_script/pages.py --no-pages --push                 # groupes seulement (groups.txt) : scrape, IA, base
